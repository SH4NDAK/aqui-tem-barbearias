...
const buttonVariants = cva(
    ...
    "flex justify-center items-center bg-[#242222] p-2 w-full rounded-md text-white font-semibold text-sm hover:bg-[#272525] shadow-sm shadow-black transition-colors",
    {
...
// componente botão
const Button = React.forwardRef(({ onClick, type, variant, className, children }, ref) => {
    return (
        <button
            ref={ref}
